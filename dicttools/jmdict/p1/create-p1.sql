...
create table if not exists y_g1 (
	cp	integer,
	yomi	varchar(10),
	wd_cnt	integer,
...
create table if not exists y_g2 (
	cp	integer,
	yomi	varchar(10),
	wd_cnt	integer,
	foreign key(cp) references k(cp),
...
create table if not exists y_g3 (
	cp	integer,
	yomi	varchar(10),
	wd_cnt	integer,
	foreign key(cp) references k(cp),
...
create table if not exists y_g4 (
	cp	integer,
	yomi	varchar(10),
	wd_cnt	integer,
	foreign key(cp) references k(cp),
...
create table if not exists y_g5 (
	cp	integer,
	yomi	varchar(10),
	wd_cnt	integer,
	foreign key(cp) references k(cp),
...
create table if not exists y_g6 (
	cp	integer,
	yomi	varchar(10),
	wd_cnt	integer,
	foreign key(cp) references k(cp),
...
create table if not exists y_gjo (
	cp	integer,
	yomi	varchar(10),
	wd_cnt	integer,
	foreign key(cp) references k(cp),
